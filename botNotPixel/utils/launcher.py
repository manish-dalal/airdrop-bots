...
from botNotPixel.core.tapper import run_tapper, run_tapper1
from botNotPixel.core.query import run_query_tapper, run_query_tapper1
from botNotPixel.core.registrator import register_sessions
